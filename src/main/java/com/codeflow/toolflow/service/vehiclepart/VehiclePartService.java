...
public interface VehiclePartService {
     ...
     * @param VehicleAssociatedId The ID of the vehicle associated with the part, if applicable.
     * @param request       DTO containing the new quantity.
     */
    void updateStock(Long partId, Long headquarterId, Long VehicleAssociatedId, UpdateStockRequest request);
